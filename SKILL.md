...
- `references/douyin-publish-pack-template.md` - 需要产出抖音发布包时读取
- `references/xiaohongshu-publish-pack-template.md` - 需要产出小红书发布包时读取
